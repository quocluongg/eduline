...
export const clubsData: Club[] = [
  {
    ...
    name: "CLB Lập trình",
    description:
      "Nghiên cứu và chia sẻ kiến thức về lập trình, tham gia các cuộc thi",
    tags: ["Coding", "Contest"],
  },
  {
    id: 2,
...
export const teamActivitiesData: TeamActivity[] = [
  ...
  },
  {
    ...
    items: ["CLB Bóng đá", "CLB Cầu lông", "CLB Bóng rổ"],
  },
];
    ...
    periods: [
      {
        ...
        room: "C302",
        teacher: "PGS. Vũ Văn H",
      },
      {
        time: "9:15-11:15",
        subject: "Phân tích thiết kế hệ thống",
        room: "A103",
        teacher: "TS. Bùi Thị I",
      },
      {
        time: "13:00-15:00",
        subject: "Mạng máy tính",
  ...
  return (
    <PublicLayout>
      <div className="w-full bg-white">
        {/* hero */}
        <img
          src="https://ptit.edu.vn/wp-content/uploads/2024/09/SV-4.webp"
            ...
            <div className="py-10">
              ...
              <div className="mt-6 flex flex-col gap-3 bg-[#E6ECE0] p-6 rounded-3xl text-[#3A4F30]">
                ...
                <ul className="list-disc list-inside space-y-1 text-sm">
                  ...
                  <li>
                    Lịch học có thể thay đổi, theo dõi thông báo từ giảng viên
                  </li>
